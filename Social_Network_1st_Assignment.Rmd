...
## 7. What is the clustering coefficient (transitivity) in the network?
...
## 8. What is the assortativity (degree) in the network?
...
## 9. Using the Louvain method, does the network have a community structure?
...
## 10. If so, what is its modularity?**
...
## 11. Test that the clustering coefficient in the network cannot be statistically explained by a configuration model in which the nodes have the same degree distribution as the original.
...
## 12. Visualize the neighborhood of the node with the largest centrality (closeness).
